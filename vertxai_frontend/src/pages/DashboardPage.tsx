            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                <div className="bg-green-50 p-4 rounded-lg border border-green-100">
                  <h3 className="text-sm font-medium text-green-800">Completed Deals</h3>
                  <p className="text-2xl font-bold text-green-700 mt-2">
                    {deals.filter((d) => d.status === "completed").length}
                  </p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                  <h3 className="text-sm font-medium text-blue-800">Active Deals</h3>
                  <p className="text-2xl font-bold text-blue-700 mt-2">
                    {deals.filter((d) => d.status === "progress").length}
                  </p>
                </div>
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-100">
                  <h3 className="text-sm font-medium text-yellow-800">Pending Deals</h3>
